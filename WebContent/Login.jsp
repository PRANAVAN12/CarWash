...
<!-- Font Icon -->
<link rel="stylesheet"
	href="Register/fonts/material-icon/css/material-design-iconic-font.min.css">
			...
			<div class="container">
				<div class="signin-content">
					<div class="signin-image">
						<figure>
							<img src="Register/images/signin-image.jpg" alt="sing up image">
						</figure>
						<a href="<%=request.getContextPath()%>/newuserregister"
					...
					<div class="signin-form">
						...
						<form method="post" action="loginUser" class="register-form"
							...
							<h3 style="color: red">
								<input type="text"
									style="color: red; border-bottom: none !important; box-shadow: none !important;"
